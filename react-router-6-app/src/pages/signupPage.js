...
function SignUpPage() {
    ...
    async function fetchAllUniversities(currentPage = 1) {
        const response = await fetch(`https://ratemyuni.onrender.com/api/getAllUniversities?page=${currentPage}`);
    ...
    async function fetchAllDepartments(universityId, currentPage = 1) {
        const response = await fetch(`https://ratemyuni.onrender.com/api/getDepartmentsByUniversity/${universityId}?page=${currentPage}`);
        const data = await response.json();
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await fetch('https://ratemyuni.onrender.com/api/auth/signup', {
                method: "POST",
                headers: {
